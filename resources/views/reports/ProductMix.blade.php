...
@section('aditionalScripts')
    ...
    <script type="text/javascript">
        ...
        function makeTable(data) {
            clearTable();
            let htmlTemplate =
                "<td class=\"text-left\">:itemno</td><td class=\"text-left\">:family</td><td class=\"text-left\">:itemname</td><td class=\"text-right\">:breakfast</td><td class=\"text-right\">:Lunch</td><td class=\"text-right\">:Dinner</td><td class=\"text-right\">:night</td><td class=\"text-right\">:preference</td><td class=\"text-right\">:netSales</td><td class=\"text-right\">:perfamily</td><td class=\"text-right\">:permajor</td><td class=\"text-right\">:permenu</td><td class=\"text-right\">:cost</td><td class=\"text-right\">:costper</td><td class=\"text-right\"><b>:margin</b></td>";
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                innerHTML = innerHTML.replace(':family', "<b>" + data[i].family + "</b>");
